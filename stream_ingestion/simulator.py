...
MERCHANT_CATEGORIES =[
"grocery","restaurant","gas_station","online",
"retail","travel","atm","other",
]
...
class TransactionSimulator :
    ...
    async def run (self ,duration_seconds :float =0.0 )->None :
        ...
        len (self ._profiles ),self ._target_rps ,
        )
...
if __name__ =="__main__":
    ...
    parser .add_argument ("--duration",type =float ,default =60.0 ,help ="Runtime in seconds (0=forever)")
