...
class InferenceClient :
    ...
    timeout_ms :int =5_000 ,
        ...
        try :
            ...
            "Run `python scripts/compile_proto.py` first."
            )from exc
    ...
    def batch_predict (self ,requests :list [dict ])->list [PredictionResult ]:
        ...
        for r in requests :
            ...
            pb_requests .append (self ._pb2 .InferenceRequest (
            request_id =txn_id ,
            transaction =self ._pb2 .Transaction (
            transaction_id =txn_id ,
...
if __name__ =="__main__":
    ...
    with InferenceClient (target )as client :
        ...
        try :
            h =client .health ()
            print (f"Server healthy: {h .healthy }  model v{h .version }  "
        ...
        if latencies :
            ...
            print (f"\n  mean latency: {mean (latencies ):.2f}ms  "
