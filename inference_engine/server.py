...
if PROM_AVAILABLE :
    ...
    FRAUD_SCORE_HIST =Histogram ("fraud_score","Distribution of fraud scores",
...
def main ()->None :
    ...
    if not os .path .exists (model_path ):
        logger .error ("Model not found at %s — run `python scripts/train_model.py` first.",model_path )
        return
